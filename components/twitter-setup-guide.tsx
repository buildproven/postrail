...
export function TwitterSetupGuide({ onSuccess }: TwitterSetupGuideProps) {
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.details || data.error || 'Failed to connect Twitter')
      }
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            To connect Twitter, you&apos;ll need to create your own Twitter Developer account and app.
            This gives you 500 posts/month on the free tier.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Click &quot;Create Project&quot; → Name it (e.g., &quot;LetterFlow Bot&quot;) → Create an app within the project
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Go to your app → Settings → User authentication settings → Enable OAuth 1.0a →
          ...
          <Alert>
            <AlertDescription className="text-sm">
              <strong>Why BYOK?</strong> Twitter&apos;s free tier limits 500 posts/month per app.
              By using your own keys, you get your own 500/month quota instead of sharing with other users.
            </AlertDescription>
          </Alert>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                type="button"
                onClick={() => setShowSecrets({ ...showSecrets, accessTokenSecret: !showSecrets.accessTokenSecret })}
                className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700"
              >
